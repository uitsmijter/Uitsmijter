...
**Acceptance Criteria**:
- [ ] Endpoint registered at `POST /revoke`
- [ ] Client authentication implemented (reuse TokenController pattern)
- [ ] Token ownership validation implemented
...
- [ ] DocC documentation with RFC references
- [ ] Unit-Tests has been written
- [ ] e2e-Tests has been written
...
**Acceptance Criteria**:
- [ ] Can retrieve AuthSession without deleting it
- [ ] Can validate client ownership
- [ ] Returns nil if token doesn't exist (not an error)
...
**Acceptance Criteria**:
- [ ] Revoking refresh token invalidates all related access tokens
- [ ] Cascading deletions are logged
- [ ] Metrics track cascading revocations
...
**Acceptance Criteria**:
- [ ] Route registered in correct position
- [ ] Uses same middleware as token endpoint
...
**Acceptance Criteria**:
- [ ] Discovery document includes `revocation_endpoint`
- [ ] Endpoint URL is correct
- [ ] Documentation updated with RFC reference
- [ ] Multi-tenant support (different issuers per tenant)
- [ ] Unit-Tests has been written
- [ ] e2e-Tests has been written
...
**Acceptance Criteria**:
- [ ] Prometheus metric defined
- [ ] Metric incremented on each revocation attempt
- [ ] Labels capture relevant dimensions
- [ ] Metric documented in `/metrics` endpoint docs
...
- [ ] References RFC 7009
- [ ] Explains cascading revocation
- [ ] Covers security considerations
- [ ] Shows integration with popular OAuth libraries
...
**Acceptance Criteria**:
- [ ] Discovery example includes revocation_endpoint
- [ ] Linked to revocation endpoint documentation
...
**Acceptance Criteria**:
- [ ] Metric documented with description
...
- [ ] Placed in correct section (Features)
...
### Phase 3: Testing
- [ ] Task 3.1: Unit Tests (11 test cases)
- [ ] Task 3.2: Integration Tests
- [ ] Task 3.3: E2E Tests
...
### Phase 5: CHANGELOG and Release
- [ ] Task 5.1: Update CHANGELOG
- [ ] Task 5.2: Update OpenAPI/Swagger Documentation (if applicable)
